...
const statutStyles: Record<Ticket["id_status"], string> = {
	1: "bg-indigo-100 text-indigo-600 border border-indigo-300",
	2: "bg-yellow-100 text-yellow-600 border border-yellow-300",
	3: "bg-emerald-100 text-emerald-600 border border-emerald-300",
};
